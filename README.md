...
[immoportal.com](https://www.immoportal.com/) сразу по восьми городам NRW
(Mülheim an der Ruhr, Neuss, Köln, Düsseldorf, Essen, Oberhausen, Hilden,
Münster) и шлёт в Telegram новые объявления, которые укладываются в лимиты
по цене и площади, допустимые джобцентром для одного человека.
...
- Фильтрация по городу — через числовой `city_id` в пути URL
  ...
  всех 8 городов, включая Mülheim an der Ruhr (там, где у Kleinanzeigen и
...
- Фильтрация по городу — слаг в пути URL
  ...
  вручную по `<title>` для всех 8 городов, включая Mülheim an der Ruhr.
...
все восемь городов на всех четырёх сайтах и шлёт уведомления в чат с ботом.
