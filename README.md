...
[immowelt.de](https://www.immowelt.de/) и [wg-gesucht.de](https://www.wg-gesucht.de/) сразу
по восьми городам NRW (Mülheim an der Ruhr, Neuss, Köln, Düsseldorf, Essen,
Oberhausen, Hilden, Münster) и шлёт в Telegram новые объявления, которые
укладываются в лимиты по цене и площади, допустимые джобцентром для одного
человека.

Quoka.de пробовали подключать четвёртым источником, но отказались — общая
площадка объявлений с невалидным JSON, объявления часто без фото и низкого
качества по сравнению с остальными тремя сайтами.
