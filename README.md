...
и [immowelt.de](https://www.immowelt.de/) сразу по восьми городам NRW
...
Quoka.de пробовали подключать третьим источником, но отказались — общая
площадка объявлений с невалидным JSON, объявления часто без фото и низкого
качества по сравнению с Kleinanzeigen/Immowelt.
...
- **Bürgergeld-отказ** — некоторые арендодатели прямо пишут в описании
  ...
  недоступно из-за капчи на странице объявления.
...
все восемь городов на обоих сайтах и шлёт уведомления в чат с ботом.
